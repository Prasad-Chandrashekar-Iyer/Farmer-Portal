...
$query = mysqli_query($aVar ,"SELECT * FROM rash");

$datas = array();

   while($row = mysqli_fetch_array($query)){
   	$State_Government_Subsidies = $row['Amount'];
   	$datas[] = $State_Government_Subsidies;
...
$graph->xaxis->SetTickLabels(array('Power','Irrigation','Crop Insurance','Loan Waivers'));
