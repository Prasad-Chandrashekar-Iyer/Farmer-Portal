...
//$sql = "SELECT * FROM `table` WHERE State='Tamil Nadu' AND District='ARIYALUR' AND ratio>=50 ORDER BY ratio DESC LIMIT 2";
$sql= "SELECT DISTINCT Crop FROM `table` WHERE State='".$state."' AND District='".$dis."' AND ratio>=50 ORDER BY ratio DESC";
